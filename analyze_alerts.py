...
class AlertAnalyzer:
    ...
    def analyze(self) -> Dict[str, Any]:
        ...
        if self.days_back_start and self.days_back_start > self.days_back:
            print(f"🔍 Fetching Google Alerts from {self.days_back_start} to {self.days_back} days ago...")
        else:
        ...
        if self.days_back_start and self.days_back_start > self.days_back:
            print(f"📊 Google Alerts statistics ({self.days_back_start} to {self.days_back} days ago):")
        else:
